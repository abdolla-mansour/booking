...
@section('active_nav_calender', 'active')
...
@section('header')
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/fullcalendar/main.css') }}">
  <!-- Theme style -->
...
@section('footer')
  ...
  <!-- fullCalendar 2.2.5 -->
  <script src="{{ asset('dashboard_assets/plugins/fullcalendar/main.js') }}"></script>
