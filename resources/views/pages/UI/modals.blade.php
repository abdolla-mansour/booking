...
@section('active_link_ui_modals', 'active')
...
@section('header')
<link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css') }}">
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/toastr/toastr.min.css') }}">
@endsection

@section('footer')
  <script src="{{ asset('dashboard_assets/plugins/sweetalert2/sweetalert2.min.js') }}"></script>
    ...
    $(function() {
      ...
      $('.toastsDefaultFullImage').click(function() {
        $(document).Toasts('create', {
          ...
          title: 'Toast Title',
          subtitle: 'Subtitle',
          image: '{{ asset("dashboard_assets/dist/img/user3-128x128.jpg") }}',
