...
@section('active_link_ui_sliders', 'active')
...
@section('header')
  <!-- Ion Slider -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/ion-rangeslider/css/ion.rangeSlider.min.css') }}">
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/bootstrap-slider/css/bootstrap-slider.min.css') }}">
@endsection
