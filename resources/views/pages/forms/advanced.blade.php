...
@section('active_link_form_advanced', 'active')
...
@section('header')
  ...
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css') }}">
  <!-- Select2 -->
  ...
  <!-- BS Stepper -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/bs-stepper/css/bs-stepper.min.css') }}">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/dropzone/min/dropzone.min.css') }}">
@endsection
...
@section('footer')
  ...
  <!-- bootstrap color picker -->
  <script src="{{ asset('dashboard_assets/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js') }}"></script>
  <!-- Bootstrap Switch -->
  <script src="{{ asset('dashboard_assets/plugins/bootstrap-switch/js/bootstrap-switch.min.js') }}"></script>
  <!-- BS-Stepper -->
  <script src="{{ asset('dashboard_assets/plugins/bs-stepper/js/bs-stepper.min.js') }}"></script>
  <!-- dropzonejs -->
  <script src="{{ asset('dashboard_assets/plugins/dropzone/min/dropzone.min.js') }}"></script>
  <!-- AdminLTE App -->
