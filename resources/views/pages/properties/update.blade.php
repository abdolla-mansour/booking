                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dashboard.props.update', $prop->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            @enderror
                            <br>
                            <input name="location" value="{{ old('location') ?? $prop->location }}" class="form-control" type="text" placeholder="location">
                            @error('location')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <br>
                            <input name="property_type" value="{{ old('property_type') ?? $prop->property_type }}" class="form-control" type="text" placeholder="property_type">
                            @error('property_type')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                            <br>
