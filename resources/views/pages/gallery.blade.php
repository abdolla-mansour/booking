...
@section('active_nav_gallery', 'active')
...
@section('header')
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/ekko-lightbox/ekko-lightbox.css') }}">
@endsection

@section('footer')
  <!-- Ekko Lightbox -->
  <script src="{{ asset('dashboard_assets/plugins/ekko-lightbox/ekko-lightbox.min.js') }}"></script>
  <!-- AdminLTE App -->
  <script src="{{ asset('dashboard_assets/dist/js/adminlte.min.js') }}"></script>
  <!-- Filterizr-->
  <script src="{{ asset('dashboard_assets/plugins/filterizr/jquery.filterizr.min.js') }}"></script>
