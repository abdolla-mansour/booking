...
@section('active_link_uplot', 'active')
...
@section('header')
<link rel="stylesheet" href="{{ asset('dashboard_assets/plugins/uplot/uPlot.min.css') }}">
@endsection

@section('footer')
  <script src="{{ asset('dashboard_assets/plugins/uplot/uPlot.iife.min.js') }}"></script>
  <script>
    $(function () {
      /* uPlot
      * -------
