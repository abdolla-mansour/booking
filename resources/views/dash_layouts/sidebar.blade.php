      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-nav') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Top Navigation</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-sidebar') }}" class="nav-link {{ $active_nav_sidebar ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Top Navigation + Sidebar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-boxed') }}" class="nav-link {{ $active_boxed ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Boxed</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-fixed-sidebar') }}" class="nav-link {{ $active_fixed_sidebar ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Sidebar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-fixed-sidebar-custom') }}" class="nav-link {{ $active_fixed_custom ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Sidebar <small>+ Custom Area</small></p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-fixed-topnav') }}" class="nav-link {{ $active_fixed_topnav ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Navbar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-fixed-footer') }}" class="nav-link {{ $active_fixed_footer ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Footer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.layout-collapsed-sidebar') }}" class="nav-link {{ $active_collapsed ?? '' }}">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @yield('active_nav_charts', '')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.charts.chartjs') }}" class="nav-link @yield('active_link_chartJs', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ChartJS</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.charts.flot') }}" class="nav-link @yield('active_link_flot', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Flot</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.charts.inline') }}" class="nav-link @yield('active_link_inline', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Inline</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.charts.uplot') }}" class="nav-link @yield('active_link_uplot', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>uPlot</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @yield('active_nav_ui_elements', '')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.general') }}" class="nav-link @yield('active_link_ui_general', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>General</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.icons') }}" class="nav-link @yield('active_link_ui_icons', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Icons</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.buttons') }}" class="nav-link @yield('active_link_ui_buttons', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buttons</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.sliders') }}" class="nav-link @yield('active_link_ui_sliders', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sliders</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.modals') }}" class="nav-link @yield('active_link_ui_modals', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Modals & Alerts</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.navbar') }}" class="nav-link @yield('active_link_ui_navbar', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Navbar & Tabs</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.timeline') }}" class="nav-link @yield('active_link_ui_timeline', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Timeline</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.ui.ribbons') }}" class="nav-link @yield('active_link_ui_ribbons', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ribbons</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @yield('active_nav_forms', '')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.form.general') }}" class="nav-link @yield('active_link_form_general', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>General Elements</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.form.advanced') }}" class="nav-link @yield('active_link_form_advanced', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Advanced Elements</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.form.editors') }}" class="nav-link @yield('active_link_form_editors', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Editors</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.form.validation') }}" class="nav-link @yield('active_link_form_validation', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Validation</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link @yield('active_nav_tables', '')">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.table.simple') }}" class="nav-link @yield('active_link_table_simple', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Simple Tables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.table.data') }}" class="nav-link @yield('active_link_table_data', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>DataTables</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('dashboard.pages.table.jsgrid') }}" class="nav-link @yield('active_link_table_jsgrid', '')">
                  <i class="far fa-circle nav-icon"></i>
                  <p>jsGrid</p>
                </a>
              </li>
